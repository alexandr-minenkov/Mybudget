...
const renderOperation = (operation) => {
    ...
    listItem.innerHTML = `${operation.description}
        <span class="history__money">${operation.amount} BYN</span>
...
const updateBalance = () => {
    ...
    totalMoneyIncome.textContent = resultIncome + ' BYN';
    totalMoneyExpenses.textContent = resultExpenses + ' BYN';
    totalBalance.textContent = (resultIncome + resultExpenses) + ' BYN';
